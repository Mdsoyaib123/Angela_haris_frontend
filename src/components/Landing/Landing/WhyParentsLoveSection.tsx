  ...
  return (
    <div className="bg-[#DDF2E6] rounded-4xl p-8 flex flex-col h-full">
      ...
      <div className="flex items-center gap-4 mb-6">
        <div className="w-10 h-10 bg-white/50 rounded-full flex items-center justify-center shrink-0 shadow-md">
          <div className="text-[#00813B]">{icon}</div>
        </div>
        <h3 className="text-lg font-semibold text-[#323C4B] leading-tight">
          {title}
        </h3>
      </div>

      {/* Description Text */}
      <p className="text-[#414D60] text-[13px] leading-relaxed">
        {description}
      </p>
    </div>
  );
