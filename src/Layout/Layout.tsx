...
import HomeNavBar from "@/components/Home/Shared/HomeNavBar";
import HomeSideBar from "@/components/Home/Shared/HomeSideBar";
      ...
      >
        ...
        <Sheet open={isMobileMenuOpen} onOpenChange={setIsMobileMenuOpen}>
          ...
          <SheetContent side="left" className="w-72 p-0 bg-white">
            <HomeSideBar onItemClick={() => setIsMobileMenuOpen(false)} />
          </SheetContent>
        </Sheet>

        {/* Scrollable Page Content */}
        <main
          className={`flex-1 overflow-y-auto mt-16 text-black bg-neutral-50 ${
...
//     <div className="flex">
//       <NavBar />
//       <main className="flex-1 mt-8 p-4 md:px-8">
//         <Outlet />
//       </main>
//     </div>
//   );
